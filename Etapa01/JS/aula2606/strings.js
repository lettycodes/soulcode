...
console.log(palavra.toLocaleLowerCase()); // Minúscula
...
console.log(frase.includes("salada"));

if (frase.includes("salada")) {
...
// Slice
console.log(arquivo.slice(0, 3)); // recorta a string do índice 0 até o 3
