...
function mostrarPorcentagem(valor) {
  let porcentagem = valor * 100 + "%";
  return porcentagem;
}

let p = mostrarPorcentagem(0.767);
console.log(p);
...
console.log(criarNomeCompleto("Letícia", "Silva"));
...
function calcularAreaCirculo(raio) {
  ...
  return area; // valor dentro da variável é retornado
}
