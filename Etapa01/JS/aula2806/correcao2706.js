...
let arquivosHtml = filtrarArquivos(arquivosPasta, ".html");
...
function extrairDigitosVerificadores(cpf) {
  const partesCpf = cpf.split("-"); // gera um array com [números, verificadores]
...
console.log(compararString("batata", "manga"));
